...
@TableName("lotto_trade_trans_user_log")
@ApiModel(value = "TradeTransUserLog对象", description = "用户流水表日志表.记录交易日志")
public class TradeTransUserLog implements Serializable {
    ...
    @ApiModelProperty(value = "交易流水类别:1：充值；2：购彩；3：返奖；4：退款；5：提款；6：购买推荐; 7：其它")
