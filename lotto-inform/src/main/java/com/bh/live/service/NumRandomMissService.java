 ...
 */
public interface NumRandomMissService {
     ...
     * @return
     */
    List<Omission> getRandom(Integer number, int varietyType, int random);
	...
	List<Omission> getTotalTwoFace(int varietyType);

	/**
	 * 总和大小
	 * */
	List<Omission> getTotalBigSmall(int varietyType);

	/**
	 * 骰子点数
	 * */
	List<Omission> getDiceCount(int varietyType);

	/**
	 * 短牌
	 * */
	List<Omission> getShortCard(int varietyType);

	/**
	 * 长牌
	 * */
	List<Omission> getLongCard(int varietyType);

	/**
	 * 三军
	 * */
	List<Omission> getTheArmy(int varietyType);
}
