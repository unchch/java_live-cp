 ...
 */
@Mapper
public interface NumberMissingDao {
     ...
     * @return
     */
    List<Omission> currentOmission(@Param("varietyType") int varietyType, @Param("number") int number, @Param("field") String field);
     ...
     * @return
     */
    List<Omission> getDateOmission(@Param("varietyType") int varietyType, @Param("sql") String sql, @Param("number") Integer number);
