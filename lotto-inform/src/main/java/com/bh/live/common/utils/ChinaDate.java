...
public class ChinaDate {
     ...
     * @throws Exception
     */
    public static Long lunarToSolar(String lunarDate, boolean leapMonthFlag) throws Exception{
        ...
        myDate = c.getTime();
      //  String dateTime = formatter.format(myDate);
        long dateTime = myDate.getTime();
        return dateTime;
    }
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(ChinaDate.lunarToSolar("20190101", false));
        System.out.println(ChinaDate.lunarToSolar("20190101", true));
    }
}