package com.bh.live.common.utils.string;
...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
     ...
     * 分割字符串进SET
     */
    public static Set<String> splitToSetString(String str) {
     ...
     * 分割字符串进SET
     */
    public static Set<Integer> splitToSetInt(String str) {
        Set<Integer> set = new HashSet<>();
        if (isEmpty(str)) {
            return set;
        }
        Integer[] ids = Convert.toIntArray(str);
        set.addAll(CollectionUtils.arrayToList(ids));
        return set;
    }
